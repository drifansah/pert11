...
#Load library 
# dan fungsi untuk mendapatkan nilai pinggir 
# untuk LBP pada gambar
...
def show_output(output_list):
    ...
    for i in range(output_list_len):
        ...
        if current_type == "gray":
            ...
            current_plot.set_yticks(range(len(ytick_list)))
    ...
    plt.show()
#fugsi main
image_file = 'ekstraksi\dede.jpeg'
...
def brighter(nilai, img):
    ...
    return img_b
image_file = 'ekstraksi\\banteng.jpeg'
image_file2 = 'ekstraksi\\alex.jpeg'
img_bgr = cv2.imread(image_file)
height, width, channel = img_bgr.shape
img_gray = cv2.cvtColor(img_bgr, cv2.COLOR_BGR2GRAY)
